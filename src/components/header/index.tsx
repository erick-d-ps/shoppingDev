      ...
      <nav className="w-full max-w-6xl h-20 flex items-center justify-between px-5 mx-auto relative">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <div className="relative w-full md:w-auto h-10 flex justify-center items-center px-4 py-1 rounded-2xl bg-white hover:bg-purple-700 hover:text-white transition-all duration-300 transform hover:scale-105">
              <Link
